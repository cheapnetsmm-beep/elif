...
const targetGroups = [
  {
    title: "Duygusal Durumlarının Yeme Alışkanlıklarını Etkilediğini Düşünenler",
    description: "Stres, üzüntü ya da yoğun duyguların yeme davranışlarını etkilediğini fark edenler.",
    gradient: "from-pink-50 to-pink-100/50",
    borderColor: "border-pink-200",
  },
  {
    title: "Kilo Sürecinde Zorlananlar",
    description: "Tekrarlayan diyet döngülerinden yorulmuş, sürdürülebilir bir yol arayanlar.",
    gradient: "from-blue-50 to-blue-100/50",
    borderColor: "border-blue-200",
  },
  {
    title: "Yeme Farkındalığı Kazanmak İsteyenler",
    description: "Açlık ve tokluk sinyallerini yeniden tanımayı hedefleyenler.",
    gradient: "from-primary-50 to-primary-100/50",
    borderColor: "border-primary-200",
  },
  {
    title: "Stres ve Kaygının Yeme Üzerindeki Etkisini Anlamak İsteyenler",
    description: "Günlük stres ve kaygının yeme davranışlarına yansıdığını fark edenler.",
    gradient: "from-purple-50 to-purple-100/50",
    borderColor: "border-purple-200",
  },
  {
    title: "Diyet Döngüsünden Çıkmak İsteyenler",
    description: "Katı kurallar ve yasaklar arasında sıkışmış hissedenler.",
    gradient: "from-orange-50 to-orange-100/50",
    borderColor: "border-orange-200",
  },
  {
    title: "Beden ve Zihin Sağlığını Birlikte Ele Almak İsteyenler",
    description: "Beslenme ve psikolojik iyi oluşu birlikte değerlendirmek isteyenler.",
